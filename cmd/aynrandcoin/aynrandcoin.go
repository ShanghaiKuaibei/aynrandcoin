...
var (
	...
	GenesisSignatureStr = "a09b35fc5a6e821cfdc78ff106c404733bd5e67a457a5b74227313d96c2b3991107581d3e16741ae063d954c3c6dc15c1419eeb50bd4b5779f3537b15f43316c01"
	// GenesisAddressStr genesis address string
	GenesisAddressStr = "BRpA3EuHcrqTSxgrzkNsXbj4WYQMMsWKDX"
	// BlockchainPubkeyStr pubic key string
	BlockchainPubkeyStr = "02c653b7db980703394a6e66ce8aa1001f7536a10758052193f52eee9b8cb8c34f"
	// BlockchainSeckeyStr empty private key string
	BlockchainSeckeyStr = ""

	// GenesisTimestamp genesis block create unix time
	GenesisTimestamp uint64 = 1494930215
	// GenesisCoinVolume represents the coin capacity
	GenesisCoinVolume uint64 = 300e12

	// DefaultConnections the default trust node addresses
	DefaultConnections = []string{
		"176.122.166.133:7300",
		"176.122.187.250:7300",
	}
)
...
type Config struct {
	...
	// Data directory holds app data -- defaults to ~/.aynrandcoin
...
func (c *Config) register() {
	...
	flag.StringVar(&c.DataDirectory, "data-dir", c.DataDirectory, "directory to store app data (defaults to ~/.aynrandcoin)")
	flag.StringVar(&c.DBPath, "db-path", c.DBPath, "path of database file (defaults to ~/.aynrandcoin/data.db)")
	...
	flag.StringVar(&c.WalletDirectory, "wallet-dir", c.WalletDirectory, "location of the wallet files. Defaults to ~/.aynrandcoin/wallet/")
...
var devConfig = Config{
	...
	PeerListURL:            "https://downloads.aynrandcoin.net/blockchain/peers.txt",
	...
	LaunchBrowser: false,
	// Data directory holds app data -- defaults to ~/.aynrandcoin
	DataDirectory: filepath.Join(home, ".aynrandcoin"),
